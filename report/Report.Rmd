...
The difference between the two rankings may occur because teams can be recorded as the home team in some matches and the away team in other matches. These labels do not necessarily mean that the match was played in the team own country.
...
The commit history shows that the project was developed gradually through several meaningful commits.

1. **Create initial project structure**  
   This commit created the main folders needed for the project.

2. **Set up RStudio project and report template**  
   This commit added the RStudio project file and the initial R Markdown report.

3. **Add FIFA World Cup datasets**  
   This commit added the four CSV datasets used in the analysis.

4. **Complete Question 1 data preparation and penalty analysis**  
   This commit added the data preparation and penalty analysis for Question 1.

5. **Complete Questions 1 and 2 data analysis**  
   This commit added and improved the analyses for Questions 1 and 2.

6. **Fix report paths and update Questions 1 and 2**  
   This commit corrected the dataset paths and updated the report content.

7. **Complete Questions 3 and 4 analysis**  
   This commit added the penalty-shootout rankings and match-outcome analysis.

The commit messages describe the purpose of each change and demonstrate the progress of the project over time.
